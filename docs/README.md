# 📚 John Flanders Website - Documentation Hub
...
**📌 Use when:** Starting the project, onboarding new developers, or preparing for launch

---

### 🎨 [02-design-system/](./02-design-system)
...
**📌 Use when:** Designing new features, maintaining visual consistency, or updating UI
...
**📌 Use when:** Understanding past decisions, debugging, or extending existing features
...
**📌 Use when:** Deploying to production, setting up CI/CD, or troubleshooting deployments
...
**📌 Use when:** Implementing or maintaining specific features
...
**📌 Use when:** Planning new features or understanding the roadmap
...
#### Get Started
- **Run the project for the first time** → [01-getting-started/QUICKSTART.md](./01-getting-started/QUICKSTART.md)
- **Understand what's built** → [01-getting-started/PROJECT-SUMMARY.md](./01-getting-started/PROJECT-SUMMARY.md)
- **Prepare for launch** → [01-getting-started/LAUNCH-CHECKLIST.md](./01-getting-started/LAUNCH-CHECKLIST.md)

#### Design Work
- **Check colors** → [02-design-system/SOUTHWEST-COLOR-GUIDE.md](./02-design-system/SOUTHWEST-COLOR-GUIDE.md)
- **Follow UI standards** → [02-design-system/STYLE-GUIDE.md](./02-design-system/STYLE-GUIDE.md)
- **Understand design decisions** → [02-design-system/COLOR-THEORY-GUIDE.md](./02-design-system/COLOR-THEORY-GUIDE.md)

#### Build Features
- **Add e-commerce features** → [03-development/ECOMMERCE-COMPLETE.md](./03-development/ECOMMERCE-COMPLETE.md)
- **Build the admin dashboard** → [06-planning/ADMIN-DASHBOARD-PLAN.md](./06-planning/ADMIN-DASHBOARD-PLAN.md)

#### Deploy
- **Deploy to any platform** → [04-deployment/DEPLOYMENT.md](./04-deployment/DEPLOYMENT.md)
- **Deploy to Vercel specifically** → [04-deployment/VERCEL-DEPLOY.md](./04-deployment/VERCEL-DEPLOY.md)
- **Quick deployment reference** → [04-deployment/QUICK-DEPLOY.md](./04-deployment/QUICK-DEPLOY.md)
...
- New major feature completed → Add to `05-features/`
- New deployment platform → Add to `04-deployment/`
- Design system changes → Update `02-design-system/`
- Planning new feature → Add spec to `06-planning/`

### When to Update Existing Docs
- Feature changes → Update relevant feature doc
- Design standards change → Update style guide
- Deployment process changes → Update deployment guides
